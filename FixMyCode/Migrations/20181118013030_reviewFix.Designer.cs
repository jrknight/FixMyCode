...
namespace FixMyCode.Migrations
{
    ...
    [Migration("20181118013030_reviewFix")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FixMyCode.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FixMyCode.Entities.Query", b =>
                {
                    b.HasOne("FixMyCode.Entities.Review", "Review")
                        .WithOne("Query")
                        .HasForeignKey("FixMyCode.Entities.Query", "ReviewId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FixMyCode.Entities.AppUser")
                        .WithMany()
